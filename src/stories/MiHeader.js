...
import DropdownCard from '../components/MiHeader/DropdownCard';
import DropdownList from '../components/MiHeader/DropdownList';
...
const cagegoryLists = [
    ...
    [
        ...
        },
        {
            flag: '',
            href: 'https://www.mi.com/mi5x/',
            imgUrl: 'https://i1.mifile.cn/f/i/g/2015/cn-index/saodijiqiren320-220.jpg',
            title: '米家扫地机器人',
            price: '1699元'
        },
        {
...
storiesOf('Mi Header', module)
    .add('standalone Search', () => <Centered><MiSearch/></Centered>)
    .add('MiHeader w/o Search', () => <MiHeader/>)
    .add('MiHeader with Search', () => <MiHeader RightSlot={MiSearch}/>)
    .add('DropdownCard w/o flag', () => <DropdownCard {...cagegoryLists[0][4]}/>)
    .add('DropdownCard with flag', () => <DropdownCard {...cagegoryLists[0][0]}/>)
    .add('drop down list', () => <DropdownList list={cagegoryLists[3]}/>)
    .add('Completed', () => <MiHeader lists={cagegoryLists} RightSlot={MiSearch} Dropdown={DropdownList}/>)
